...
parser.add_argument('--style_path',
                    default='/imatge/mgrau/work/segmentation+styleTransf/style/minimalist_24.jpg',
                    help='Style image path (Ex:../minimalist.jpg)')

parser.add_argument('--content_path', type=str,
                        default='/imatge/mgrau/work/segmentation+styleTransf/cont/rustic/rustic_144.jpg',
                        help='Content image path (Ex:../rustic.jpg)')

parser.add_argument('--mask_path', type=str,
                        default='/imatge/mgrau/work/segmentation+styleTransf/mask/rustic/rustic_144_mask.jpg',
                        help='Mask image path (Ex:../minimalist_mask.jpg)')

parser.add_argument('--st_output', type=str,
                        default='/imatge/mgrau/work/segmentation+styleTransf/Results/output.jpg',
                        help='Style Transfer output image path (Ex:../minimalist_mask.jpg)')

parser.add_argument('--result', type=str,
                        default='/imatge/mgrau/work/segmentation+styleTransf/Results/result.jpg',
...
# srun --gres=gpu:1,gmem:6G --mem 5G --x11 python neural_style_tutorial.py
...
###IMAGES PATH###
# style_path = "/imatge/mgrau/work/segmentation+styleTransf/style/minimalist_24.jpg"
# content_path = "/imatge/mgrau/work/segmentation+styleTransf/cont/rustic/rustic_144.jpg"
# mask_path = "/imatge/mgrau/work/segmentation+styleTransf/mask/rustic/rustic_144_mask.jpg"
######################################################################
style_img = image_loader(args.style_path)
content_img = image_loader(args.content_path)
mask_img = image_loader(args.mask_path)

content = cv2.imread(args.content_path)
mascara= cv2.imread(args.mask_path)

assert style_img.size() == content_img.size() == mask_img.size(), \
...
torchvision.utils.save_image(output,args.st_output)

##################################################################
#APPLY MASK
output= cv2.imread(args.st_output)
result = apply_mask(content,output,mascara)
##---SAVE IMAGE
